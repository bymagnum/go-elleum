...
import (
	...
	"github.com/bymagnum/go-elleum/cmd/utils"
	...
	"github.com/bymagnum/go-elleum/ethclient"
...
var (
	...
	ethPortFlag = flag.Int("ethport", 37988, "Listener port for the devp2p connection")
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/bymagnum/go-elleum/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
