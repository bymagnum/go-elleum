...
!define HELPURL "https://github.com/bymagnum/go-elleum/issues"
!define UPDATEURL "https://github.com/bymagnum/go-elleum/releases"
!define ABOUTURL "https://github.com/bymagnum/go-elleum#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:37988)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:37988)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:37988)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:37988)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 37988 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:37988)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 37988 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:37988)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 37988 "" ""
