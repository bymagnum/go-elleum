...
import (
	...
	"github.com/bymagnum/go-elleum/crypto/signify"
	"github.com/bymagnum/go-elleum/internal/build"
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/bymagnum/go-elleum/mobile")
